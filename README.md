...
Keeping the y-axis of the robot $dy$ parallel to the exterior border straightness $dex$ helps the robot navigate safely without crashing into the wall. The angle $theta$ between $dy$ and $dex$ is calculated using:
$$\theta = \tan^{-1} \left(\frac{d_1 - d_2}{d}\right)$$
Where:
...
$$D = \frac{d_1 + d_2}{2} \cos \theta$$
Where:
- $d_1$ and $d_2$ are the same as in the equation above.
- $\theta$ is the angle calculated according to the equation above.
...
![Robot Circuit Proteus Design](images/ApplicationsProject.SVG "Robot Circuit Proteus Design")<p align="center" Style="font-size:12px; color:grey; font-type:italic;"><i> Figure 1: Robot Circuit Proteus Design</i></p>
...
![Before Applying Moving Average Filter](images/before.svg "Before Applying Moving Average Filter")<p align="center" Style="font-size:12px; color:grey; font-type:italic;"><i> Figure 2: Before Applying Moving Average Filter on Sensor Measurements</i></p> 
| Window Size | 5 | 7 | 10 | 15 |
|-------------|---|---|----|----|
| Error Standard Deviation | 0.0631 | 0.0521 | 0.0449 | 0.0383 |
| Filtering Results| ![After Applying Moving Average Filter (Window Size = 5)](images/after_5.svg "After Applying Moving Average Filter (Window Size = 5)")<p align="center" Style="font-size:12px; color:grey; font-type:italic;"><i> Figure 3: After Applying Moving Average Filter (Window Size = 5)</i></p> | ![After Applying Moving Average Filter (Window Size = 7)](images/after_7.svg "After Applying Moving Average Filter (Window Size = 7)")<p align="center" Style="font-size:12px; color:grey; font-type:italic;"><i> Figure 4: After Applying Moving Average Filter (Window Size = 7)</i></p> | ![After Applying Moving Average Filter (Window Size = 10)](images/after_10.svg "After Applying Moving Average Filter (Window Size = 10)")<p align="center" Style="font-size:12px; color:grey; font-type:italic;"><i> Figure 5: After Applying Moving Average Filter (Window Size = 10)</i></p> | ![After Applying Moving Average Filter (Window Size = 15)](images/after_15.svg "After Applying Moving Average Filter (Window Size = 15)")<p align="center" Style="font-size:12px; color:grey; font-type:italic;"><i> Figure 6: After Applying Moving Average Filter (Window Size = 15)</i></p>
...
|![PID Controller Response (Kp = 0.1, Kd = 0, Ki = 0)](images/Pcontrol.svg "PID Controller Response (Kp = 0.1, Kd = 0, Ki = 0)")<p align="center" Style="font-size:12px; color:grey; font-type:italic;"><i> Figure 7: PID Controller Response (Kp = 0.1, Kd = 0, Ki = 0)</i></p>|![PID Controller Response (Kp = 0.1, Kd = -0.05, Ki = 0)](images/PDControl0.05.svg "PID Controller Response (Kp = 0.1, Kd = -0.05, Ki = 0)")<p align="center" Style="font-size:12px; color:grey; font-type:italic;"><i> Figure 8: PID Controller Response (Kp = 0.1, Kd = -0.05, Ki = 0)</i></p>|![PID Controller Response (Kp = 0.1, Kd = -0.06, Ki = 0)](images/PDControl0.06.svg "PID Controller Response (Kp = 0.1, Kd = -0.06, Ki = 0)")<p align="center" Style="font-size:12px; color:grey; font-type:italic;"><i> Figure 9: PID Controller Response (Kp = 0.1, Kd = -0.06, Ki = 0)</i></p>|
|---|---|---|
...
<p align="center" Style="font-size:12px; color:grey; font-type:italic;">
  <i>Figure 10: 4-Wheeled Drive Robot Final Setup</i>
</p>
